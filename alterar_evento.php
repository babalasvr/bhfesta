...
<html>
  ...
  <div class="container-fluid" style="padding: 5px;">
	...
	<?php echo "<h1 style='text-align: center;'>Alterar seu Evento:"; ?>
...
if(strpos($url, 'erro=4572696b2046656c646e6572203231353030313432')!== false){
...
?>
	...
	<div class="cadastro">
	  <div class="form">
	    <form enctype="multipart/form-data" class="login-form" method="post" action="update_eventos.php?id=<?php echo $id_evento?>">
	      ...
	      <textarea placeholder="Descrição" name="desc_evento" style="resize: none;"></textarea>
